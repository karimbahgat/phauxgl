...
from .face import NewFace
from .pair import NewPair, MakePairKey
from .queue import PriorityQueue

from ..vertex import NewVertex

from heapq import heappush, heappop

def Simplify(input, factor):
    ...
    for p in pairs.values():
        heappush(queue, p)
        vertexPairs[p.A].append(p)
        vertexPairs[p.B].append(p)
